...
router.post(
  ...
  [
    ...
    [
      check("plateNumber", "Plate number is required")
        .not()
        .isEmpty(),
      check("department", "department field is required")
        .not()
        .isEmpty(),
      check("type", "A type is required")
        .not()
        .isEmpty(),
      check("registration", "registration date is required")
        .not()
        .isEmpty(),
      ...
      check("studentId", "StudentId is required")
        .not()
        .isEmpty(),
     check("color", "Type of color is required")
        .not()
        .isEmpty(),
      check("rating", "select of rating is required")
        .not()
        .isEmpty()
    ]
  ],
  async (req, res) => {
    ...
    try {
      ...
      newVehicle.registration = formatDate(registration);
